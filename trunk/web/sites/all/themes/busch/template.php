 ...
 */
function busch_html_head_alter(&$head_elements) {
 ...
 */
function busch_process_html(&$variables) {
 ...
 */
function busch_process_page(&$variables) {
...
function busch_page_alter($page) {
...
function busch_breadcrumb($variables) {
...
if (theme_get_setting('responsive_menu_state')) {
	...
	drupal_add_js(drupal_get_path('theme', 'busch') .'/js/jquery.mobilemenu.js');
